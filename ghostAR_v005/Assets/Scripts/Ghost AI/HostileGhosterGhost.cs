...
public class HostileGhosterGhost : MonoBehaviour, IGhost, IPlayerHitable {
    ...
    /// <summary>
    /// Checks the Hostile's Fade status.
    /// </summary>
    ...
    /// <summary>
    /// Picks the direction the Hostile will roam in randomly.
    /// </summary>
    ...
    /// <summary>
    /// Moves the Hostile around the player.
    /// </summary>
    ...
    /// <summary>
    /// Retricts certain values so they do not go over or under they're limits.
    /// </summary>
    ...
    /// <summary>
    /// The behavior that happens when the player hits this hostile.
    /// </summary>
