...
public class webCamScript : MonoBehaviour {
    /// <summary>
    /// The plane that the Web Cam Texture plays on.
    /// </summary>
    [Tooltip("The plane that the Web Cam Texture plays on.")]
    public GameObject webCameraPlane;

    public Text debuggybug;
	...
	void Update () {
        ...
        debuggybug.text = SystemInfo.supportsGyroscope.ToString();
